...
"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"--"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-"-
        ...
        augroup END
        "------------------------------------------------------------------------------------------
        "Ex: :Ex Pull word under cursor into LHS of a subs ztitute (replace)
...
"-aaa20-PrePLAY0-remap---------------------------------------------------------------------------------------{{{
        ...
        " nnoremap <leader>wr :execute "rightbelow vsplit" bufname('#')<cr>
        nnoremap BB ggVG
        "-it's-2018--------------------------
        noremap j gj
        noremap k gk
...
"-AAA21--PLAY--Start--Ag--CtrlP--Unite--CommandT--BigList-400-------------------------------------------------------{{{
        ...
        "===PLAY3==================================================================================
                ...
                nnoremap <Leader>q :Unite help file_mru file buffer file_rec bookmark <CR>
...
"-AAA21--PLAY--STOP--BigList800-}}}
        ...
        "----------------------------------------------------------------------------------
        " Split previously opened file ('#') in a split window
        nnoremap ;s :execute "leftabove vsplit" bufname('#')<cr>
        nnoremap ;w :execute "rightbelow vsplit" bufname('#')<cr>
        "----------------------------------------------------------------------------------
        nnoremap <C-j> :bn<cr>
        nnoremap <C-k> :bp<cr>
        "--------------------------------------------------
