...
"My stuff --------------------------------------------------------------------------
autocmd filetype cpp nnoremap <F5> :!g++ % -ggdb -o %:r <CR>
autocmd filetype cpp nnoremap<F6> :!g++ % -ggdb -o %:r && ./%:r <CR>
autocmd filetype cpp nnoremap<F10> :!g++ % -ggdb -o %:r && gdb -tui %:r <CR>

"My stuff --------------------------------------------------------------------------

" F7 Google/code search
function! OnlineDoc3()
