...
#!/usr/bin/R
setwd("/home/alf/git/aTest/RStat/R1R/")
mydata<- read.csv("/home/alf/git/aTest/RStat/R1R/dot2Gad2.csv")
attach(mydata)
boxplot(mydata)
...
mydata<- read.csv("/home/alf/git/aTest/RStat/R1R/beaCSLR4.csv")
attach(mydata)
boxplot(mydata)
var.test(RCS, LCS)
var.test(RCS, Bone)
...
#====================================================================
# Read the data
mydata<- read.csv("/home/alf/git/aTest/RStat/R1R/intro_auto.csv")
mydata<- read.csv("/home/alf/git/aTest/RStat/R1R/bea5roi.csv")
attach(mydata)
